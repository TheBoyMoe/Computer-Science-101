...
describe("#Stack", function(){
    it("contains a first and last property", function(){
...
describe("#Node", function(){
    it("contains a value, next and prev property", function(){
...
describe("#push", function(){
    ...
    it("places the value at the top of the stack", function(){
        ...
        stack.push(100)
        expect(stack.first.value).to.equal(10)
        expect(stack.last.value).to.equal(100)
        stack.push(1000)
        expect(stack.first.value).to.equal(10)
        expect(stack.last.value).to.equal(1000)
    });
});
